	    ...
	    ?>
			...
			<div class="row justify-content-center">
                    <article class="col-lg-4 col-md-6 col-sm-8 mb-5">
						<img style="width: 250px; height: 250px" src="img/foodshala.png" alt="Image" class="rounded responsive"/>
					</article>
					 <article class="col-lg-4 col-sm-8 col-md-6">
					<h4 class="name">Welcome to FoodShala</h4>
					<p>We provide better and quality for the customers. This is online platform where Restaurants can be registre here and after that they can add Menu Items. Customers can be register here and can order from any restaurants and many items in one time from Menu Items.!!! 
